...
//---------------------------------------------------------------------------
void __fastcall TForm4::trocar_arma(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TForm4::esquerda2(TObject *Sender)
{
	f1->getJogador()->setVelX(-8);
}
//---------------------------------------------------------------------------
void __fastcall TForm4::direita2(TObject *Sender)
{
	f1->getJogador()->setVelX(8);
}
//---------------------------------------------------------------------------
void __fastcall TForm4::direita(TObject* Sender)
{
    f1->getJogador()->setVelX(0);
	Button2->ResetFocus();
}
...
void __fastcall TForm4::recarregar(TObject *Sender)
{
	f1->getJogador()->getl_arma()->getElX(f1->getJogador()->getArmaSel())->getInfo()->recarregar();
}
//---------------------------------------------------------------------------

void __fastcall TForm4::atacar2(TObject *Sender)
{
	f1->getJogador()->setAtacar(false);
}
//---------------------------------------------------------------------------

void __fastcall TForm4::atacar(TObject *Sender)
{
...
void __fastcall TForm4::loop(TObject *Sender)
{
    f1->executar();
	rolagem();
